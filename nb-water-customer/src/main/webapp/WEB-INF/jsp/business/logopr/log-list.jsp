                            ...
                            <div class="demoTable">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="username" id="username" placeholder="请输入操作用户" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="oprtime" id="oprtime" placeholder="请输入操作时间" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
    ...
    function tableData(){
        ...
        layui.use('table', function(){
            ...
            table.render({
                elem: '#demo'
                ,cols: [[ //标题栏
                    {field: 'username', title: '操作用户',minWidth:120,width:avg,align:'center'}
                    , {field: 'ip', title: '操作IP', minWidth:120,width:avg,align:'center'}
                    ,{field: 'modulename', title: '操作模块',minWidth:120,width:avg,align:'center'}
                    ,{field: 'oprcontent', title: '操作内容',minWidth:120,width:avg,align:'center'}
                    ,{field: 'oprtime', title: '操作时间',minWidth:120,width:avg,align:'center'}
                    ,{field: 'isclose', title: '操作', width:avg-15,toolbar:'#handle',align:'center'}
                ]]
                //,data: ${list}
                ,url: '${ctx}/logCustomerOpr/listData.action'
            ...
            table.on('tool(myTable)', function(obj){
                ...
                if(obj.event === 'detail'){
                    layer.open({
                        ...
                        fixed: false, //不固定
                        maxmin: true, //最大最小化
                        content: '${ctx}/logCustomerOpr/info.action?id='+data.id
                    });
                }
            });
