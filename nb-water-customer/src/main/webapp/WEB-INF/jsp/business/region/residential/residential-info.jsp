	...
	<div class="layui-fluid">
			<div class="layui-row  layui-col-space15">
				<fieldset class="layui-elem-field layui-field-title"
					...
					<legend>${residential.province }-${residential.city}-${residential.area }</legend>
				</fieldset>
				...
				<div id="nav1">
				    ...
				    <div class="layui-tab" lay-filter="main_tab1">
				        <ul id="main_tab1" class="layui-tab-title">
				            <li lay-id="0" class="layui-this">小区信息</li>
				            <li lay-id="1">楼层信息</li>
				        </ul>
				        <div class="layui-tab-content">
				            <div class="layui-tab-item layui-show">
								...
								<div class="layui-form-item">
									...
									<label class="layui-form-mid">
										<textarea style="width:450px;height:200px;" disabled >${residential.describe }</textarea>
									</label>
								</div>
				            </div>
...
layui.use(['form', 'layedit', 'laydate'], function(){
    ...
    layui.config({
        ...
        dtree.render({
            elem: "#demoTree1",  //绑定元素
            url: "${ctx}/residential/treeData.action?residentialid=${residential.id}", //异步接口
