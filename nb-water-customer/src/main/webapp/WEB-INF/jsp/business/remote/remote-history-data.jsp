...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,cols: [[ //标题栏
                {field: 'deviceId', title: '设备ID', minWidth:120,align:'center'}
                ,{field: 'content', title: '上报内容', minWidth:120,align:'center'}
                ,{field: 'ctime', title: 'upTime', minWidth: 120,align:'center'}
            	,{ title : '操作',minWidth:120,toolbar : '#handle',align:'center'}
            ]]
            //,data: ${list}
            ,url: '${ctx}/remote/history-data-data.action?deviceId=${deviceId}'
        ...
        table.on('tool(myTable)', function(obj){
            ...
            if(obj.event === 'detail'){
                layer.open({
                        ...
                        fixed : false, //不固定
                        maxmin : true,
                        content : '${ctx}/readlog/info.action?id=' + data.id
                });
            }
        });
