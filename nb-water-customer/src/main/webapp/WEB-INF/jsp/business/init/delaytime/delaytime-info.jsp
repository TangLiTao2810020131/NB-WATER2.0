...
<div class="layui-body layui-bg-white">
	<div class="layui-fluid">
			<div class="layui-row  layui-col-space15">
				...
				<input type="hidden" name="basicnumid" value="${basicnum.id }" />
				<input type="hidden" name="deliveryid" value="${delivery.id }" />
				<input type="hidden" name="valvecontrolid" value="${valvecontrol.id }" />
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="basicnumtime" value="${basicnum.value }"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="deliverytime" value="${delivery.value }"
								lay-verify="title" autocomplete="off" 
								class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="valvecontroltime" value="${valvecontrol.value }"
								lay-verify="title" autocomplete="off" 
								class="layui-input">
						</div>
					</div>
...
layui.use(['form', 'layedit', 'laydate'], function(){
     ...
     form.on('submit(demo1)', function(data){
    	 ...
    	 $.ajax({ 
		        type : "POST", //提交方式 
		        url : "${ctx}/delaytime/save.action",//路径 
