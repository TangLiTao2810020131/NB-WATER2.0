		...
		<div class="layui-fluid">
			<div class="layui-row  layui-col-space15">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">用户性质类型:</label> <label
						class="layui-form-mid">${userpro.usertype }</label>
				</div>

				<div class="layui-form-item">
					<label class="layui-form-label">描述:</label> <label
						class="layui-form-mid">${userpro.describe }</label>
				</div>
			</div>
		</div>
	</div>
