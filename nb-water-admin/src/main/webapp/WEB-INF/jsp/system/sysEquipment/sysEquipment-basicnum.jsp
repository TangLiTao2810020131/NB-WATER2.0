			...
			<div class="layui-row  layui-col-space15">
				...
				<form class="layui-form" method="post">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">表读数:</label>
						<div class="layui-input-block">
							<input type="text" name="basenum" id="basenum" lay-verify="title"
								autocomplete="off" placeholder="请输入表读数(1~90000)"
								class="layui-input">
						</div>
					</div>
...
<script type="text/javascript">
	...
	$("#demo1").click(function() {
		...
		var ids = '${ids}';
		layer.confirm("请问是否确定发送设置表读数命令!", {
			btn : [ "确定", "取消" ] //按钮
		}, function(index) {
			$.ajax({
				type : "POST", //提交方式
				url : '${ctx}/sysEquipment/readBasicNum.action', //路径
				data : {
					"id" : ids,
					"basenum" : basenum,
                    "initNames":'${initNames}',
