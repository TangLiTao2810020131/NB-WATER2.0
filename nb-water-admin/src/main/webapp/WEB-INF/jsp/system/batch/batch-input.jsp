					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="name" id="name"
								value="${batch.name }" lay-verify="title"
								autocomplete="off" placeholder="请输入批次名称" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="请输入内容" name="describe" id="describe"
								style="resize:none" class="layui-textarea">${batch.describe }</textarea>
						</div>
					</div>
...
<script type="text/javascript">
	...
	$("#demo1").click(function() {
		...
		var batchmode = $("#name").val();
		if (batchmode == ""|| batchmode == null) {
			layer.msg('请输入批次名称！', {
				icon : 7,
