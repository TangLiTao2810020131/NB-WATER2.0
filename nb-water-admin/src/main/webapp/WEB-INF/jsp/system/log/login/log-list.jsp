                                ...
                                <div class="layui-form layuiadmin-card-header-auto marginBottom">
                                    <div class="demoTable">
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="oprtime" id="oprtime" placeholder="请输入登录时间" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
    ...
    function tableData() {
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,cols: [[ //标题栏
                    {
                        ...
                        title : '登录用户',
                        minWidth :120,
                        width:avg+30,align:'center',unresize:true
                    }
                    , {
                        field : 'ipaddress',
                        title : '登录IP',
                ...
                //,data: ${list}
                ,url: '${ctx}/logLogin/listData.action'
            ...
            table.on('tool(myTable)', function(obj){
                ...
                if(obj.event === 'detail'){
                    layer.open({
                        ...
                        fixed: false, //不固定
                        maxmin: true,
                        content: '${ctx}/logLogin/info.action?id='+data.id
                    });
                }
            });
