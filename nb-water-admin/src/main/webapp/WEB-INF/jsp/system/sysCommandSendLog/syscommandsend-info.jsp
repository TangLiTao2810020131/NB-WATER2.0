		...
		<div class="layui-fluid">
			<div class="layui-row  layui-col-space15">
				...
				<div class="layui-form-item">
					...
					<label class="layui-form-mid">${cmdsend.imei}</label>
				</div>
				...
				<div class="layui-form-item">
					...
					<label class="layui-form-mid">
						<c:if test="${empty cmdsend.status}">已经送达</c:if>
						<c:if test="${cmdsend.status == 'DELIVERED'}">已经送达</c:if>
