                        ...
                        <div class="layui-form layuiadmin-card-header-auto marginBottom">
                            <div class="demoTable">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="commandid" id="commandid" placeholder="请输入设命令ID" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline">
...
<script type="text/javascript">
  ...
  --%>
    ...
    function tableData() {
        ...
        avg = (clientWidth - 200) / 7;//分割7等分，表示表格的7列
        ...
        layui.use('table', function() {
            ...
            table.render({
                ...
                cols : [ [ //标题栏
                    {
                        ...
                        title : '命令ID',
                        minWidth:120,
                        width:avg+20,align:'center',unresize:true
                    }
                    , {
                        field : 'deviceid',
                        title : '设备ID',
                    ...
                    , {
                        ...
                        title : '下发命令',
                        minWidth:120,
                        width:avg+15,align:'center',unresize:true
                    }
                    , {
                        field : 'status',
                        title : '执行状态',
                    ...
                    , {
                        ...
                        title : '发送时间',
                        minWidth:120,
                        width:avg+27,align:'center',unresize:true
                    }
                    , {
                        title : '操作',
                        width:avg,
                ...
                url : '${ctx}/syscommandsendlog/clistData.action',
                id : 'myTable',
                even : true,
                page : true, //是否显示分页
                limits : [ 15, 20, 50 ],
            ...
            table.on('tool(myTable)', function(obj) {
                ...
                if (obj.event === 'detail') {
                    layer.open({
                        ...
                        fixed : false, //不固定
                        maxmin : true,
                        content : '${ctx}/commandsendlog/cinfo.action?id=' + data.id
                    });
                }
            });
