	 						...
	 						<div class="layui-form layuiadmin-card-header-auto marginBottom">
	                            <div class="demoTable">
	                                ...
	                                <div class="layui-inline">
	                                    ...
	                                    <div class="layui-input-inline">
	                                        <input type="text" name="imei" id="imei" placeholder="请输入设备设备IMEI号" autocomplete="off" class="layui-input">
	                                    </div>
	                                </div>
	                                <div class="layui-inline">
    ...
    function tableData() {
        ...
        layui.use('table', function() {
            ...
            table.render({
                ...
                cols : [ [ //标题栏
                    {
                       ...
                       align:'center'
                        ...
                        templet : function(row) {
                            ...
                            if (row.alarmstatus == 'RSOI-1') return "故障";
                        },
                        align:'center'
                    },{
                        field : 'ctime',
                ...
                url : '${ctx}/sysalarm/listData.action',
                id : 'myTable',
                even : true,
                page : true, //是否显示分页
                limits : [ 15, 20, 50 ],
