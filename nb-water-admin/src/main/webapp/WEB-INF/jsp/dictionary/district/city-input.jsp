				...
				<input type="hidden" name="father" value="${father }" />	
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="cityid" id="cityid" value="${city.cityid }"
								lay-verify="required|cityid" autocomplete="off" placeholder="区域代码"
								class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="city" value="${city.city }"
								lay-verify="required|city" autocomplete="off" placeholder="区域名称"
								class="layui-input">
						</div>
					</div>
     ...
     form.on('submit(demo1)', function(data){
         ...
         if (id!="" && id!=null) {
             if(cityid !='${city.cityid }'){
                 ...
                 function isCkeckCityid(data){
                     var num;
                     $.ajax({
                         type : "POST", //提交方式
                         url : "${ctx}/city/isCkeckCityid.action", //路径
