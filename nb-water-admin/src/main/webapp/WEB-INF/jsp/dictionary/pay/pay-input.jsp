			...
			<div class="layui-row  layui-col-space15">
				...
				<form class="layui-form" method="post">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">付费模式类型:</label>
						<div class="layui-input-block">
							<input type="text" name="paymode" id="paymode"
								value="${pay.paymode }" lay-verify="title"
								autocomplete="off" placeholder="请输入付费模式类型" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="请输入内容" name="describe" id="describe"
								style="resize:none" class="layui-textarea">${pay.describe }</textarea>
						</div>
					</div>
