		...
		<div class="layui-fluid">
			<div class="layui-row  layui-col-space15">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">结算方式:</label> <label
						class="layui-form-mid">${settlement.settlementmethod }</label>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label">结算规则:</label> <label
						class="layui-form-mid">${settlement.settlementrules }</label>
				</div>

				<div class="layui-form-item">
					<label class="layui-form-label">描述:</label> <label
						class="layui-form-mid">${settlement.describe }</label>
				</div>
			</div>
		</div>
	</div>
