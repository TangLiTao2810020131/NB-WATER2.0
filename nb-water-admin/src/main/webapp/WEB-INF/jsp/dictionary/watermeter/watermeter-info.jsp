			...
			<div class="layui-row  layui-col-space15">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">水表型号:</label> <label
						class="layui-form-mid">${watermeter.type }</label>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label">水表口径:</label> <label
						class="layui-form-mid">${watermeter.caliber }</label>
				</div>
	
				<div class="layui-form-item">
					<label class="layui-form-label">有无阀控:</label> <label
						class="layui-form-mid">
						<c:if test="${watermeter.control == 1 }">有</c:if>
						<c:if test="${watermeter.control == 0 }">无</c:if>
						</label>
				</div>				
												
				<div class="layui-form-item">
					<label class="layui-form-label">描述:</label> <label
						class="layui-form-mid">${watermeter.describe }</label>
				</div>
			</div>
		</div>
	</div>
